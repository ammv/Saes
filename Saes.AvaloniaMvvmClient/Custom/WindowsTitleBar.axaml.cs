...
namespace Saes.AvaloniaMvvmClient.Custom
{
    public partial class WindowsTitleBar : UserControl
    {
        ...
        private async void SubscribeToWindowState()
        {
            ...
            hostWindow.GetObservable(Window.WindowStateProperty).Select(w => (w, hostWindow)).Subscribe(hostWindow_WindowState);
        }

        private void hostWindow_WindowState((WindowState s, Window hostWindow) data)
        {
            var s = data.s;
            var hostWindow = data.hostWindow;

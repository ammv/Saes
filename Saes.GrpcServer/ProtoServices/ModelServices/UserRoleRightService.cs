...
{
    public class UserRoleRightService : Saes.Protos.ModelServices.UserRoleRightService.UserRoleRightServiceBase
    {
        ...
        public override async Task<Protos.ModelServices.UserRoleRightLookupResponse> Search(Protos.ModelServices.UserRoleRightLookup request, ServerCallContext context)
        {
            ...
            //query = request.UserRoleRightID != null ? query.Where(x => x.UserRoleRightId == request.UserRoleRightID) : query;
            ...
            var dtos = await query.ProjectToType<Protos.UserRoleRightDto>(_mapper.Config).ToListAsync();
        ...
        public override async Task<StatusResponse> Edit(UserRoleRightDataRequest request, ServerCallContext context)
        {
